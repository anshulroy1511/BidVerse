      ...
      className="fixed right-5 top-5 bg-[#D6482B] text-white text-3xl p-2 rounded-md hover:bg-[#b8381e] lg-hidden">
        ...
        <div className= {`w-[100%] sm:w-[300px] bg-[#f6f4f0] h-full fixed top-0 ${
          ...
          <div className="relative">
            <Link to={"/"}>
             <h4 className='text-2xl font-semibold mb-4'> Bid
              <span className="text-[#D64826]"> Verse </span>
              </h4>
            </Link>
...
<div>
          ...
          <p className='text-stone-500'> &copy; BidVerse, LLC.</p>
          <p className='text-stone-500'>
            Designed By{" "}
            <Link to ={"/"} 
            className='className="font-semibold hover:text-[#d6482b] hover:transition-all hover:duration-150"'> 
             Anshul </Link>
          </p>
