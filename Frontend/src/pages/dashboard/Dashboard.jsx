     ...
     loading ? <Spinner/>: (
        ...
        <div className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-10">
                <div>
                    <h3 className="text-[#111] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">Monthy total payments received</h3>
                    <PaymentGraph/>
                </div>
                <div>
                ...
                <div>
                    <h3 className="text-[#111] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">Delete Items From Auctions</h3>
                    <AuctionItemDelete/>
                </div>
            </div>
        </div>
