...
const SignUp = () => {
    ...
    //  code snippet provided is an event handler for handling image uploads in a React component
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className='flex flex-col gap-1 sm:flex-row sm:gap-4'>
                    <select value={bankName} onChange={(e) => setBankName(e.target.value)} 
                         ...
                         <input type="text" value={bankAccountNumber} placeholder='IBAN/IFSC'
                          onChange={(e) => setBankAccountNumber(e.target.value) } 
                          className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1"
                          disabled= {role === "Bidder"}/>

                           <input type="text" value={bankAccountName} placeholder='Bank Account UserName'
