...
const Home = () => {
  ...
  const howItWorks = [
    ...
    {
      title: "Payment & Fees",
      description: "Bidder pays for auction and auctioneer pays 5% commission .",
    },
  ];
    ...
    <>
     <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
       <div>
         ...
         <h1 className={`text-[#111] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl`}>
          ...
          <div  className="flex gap-4 my-8">
             {
              !isAuthenticated && (
                <>
                  <Link to= "/sign-up"  className="bg-[#d6482b] font-semibold hover:bg-[#b8381e] rounded-md px-8 flex items-center py-2 text-white  transition-all duration-300">
                  Sign Up 
                  </Link>
