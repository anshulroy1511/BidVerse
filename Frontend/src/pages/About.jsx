     ...
     <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to BidVerse, the ultimate destination for online auctions
          ...
          <p className="text-xl text-stone-600">
            At BidVerse, our mission is to revolutionize the way people buy and
        ...
        <ul className='list-inside'>
          ...
          <p className="text-xl text-stone-600">
            Founded by Anshul Roy, BidVerse was born out of a passion for
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, BidVerse
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing BidVerse. We look forward to being a part of
